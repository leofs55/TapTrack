...
public class UpdateUserResponse {
    ...
    public UpdateUserResponse(UUID userId, String name, String taxId, LocalDate birthDate, String email, String phone, LocalDateTime createdAt, LocalDateTime updatedAt, UserComplianceResponse compliance, UserFinancialProfileResponse financialProfile, UserAccessControlResponse accessControl) {
        this.userId = userId;
        this.name = name;
        this.taxId = taxId;
